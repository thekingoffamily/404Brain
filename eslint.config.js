...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Brain warn -> off
			...
			// Brain - this should only apply to workbench/brain/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Brain
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Brain
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Brain
		}
	},
	// vscode TS
	{
