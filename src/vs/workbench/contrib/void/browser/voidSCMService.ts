...
class GenerateCommitMessageAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('voidCommitMessagePrompt', '404Brain: Generate Commit Message'),
			icon: ThemeIcon.fromId('sparkle'),
			tooltip: localize2('voidCommitMessagePromptTooltip', '404Brain: Generate Commit Message'),
			f1: true,
			menu: [{
...
class LoadingGenerateCommitMessageAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('voidCommitMessagePromptCancel', '404Brain: Cancel Commit Message Generation'),
			icon: ThemeIcon.fromId('stop-circle'),
			tooltip: localize2('voidCommitMessagePromptCancelTooltip', '404Brain: Cancel Commit Message Generation'),
