...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/brain/common/brainSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { BrainSettingsState } from '../../../../../../../workbench/contrib/brain/common/brainSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/brain/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/brain/common/refreshModelService.js';
import { IBrainSettingsService } from '../../../../../../../workbench/contrib/brain/common/brainSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/brain/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/brain/common/metricsService.js'
...
import { ICursorImportService } from '../../../../common/cursorImportService.js';
...
let settingsState: BrainSettingsState
const settingsStateListeners: Set<(s: BrainSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IBrainSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		brainCommandBarService: accessor.get(IBrainCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, brainCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		brainCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		brainCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IBrainSettingsService: accessor.get(IBrainSettingsService),
		...
		IBrainModelService: accessor.get(IBrainModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IBrainCommandBarService: accessor.get(IBrainCommandBarService),
		...
		ICursorImportService: accessor.get(ICursorImportService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Brain useAccessor was called before _registerServices!`)
	}
