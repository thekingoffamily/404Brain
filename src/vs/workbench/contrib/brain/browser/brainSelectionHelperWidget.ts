...
import { mountBrainSelectionHelper } from './react/out/brain-editor-widgets-tsx/index.js';
...
export type BrainSelectionHelperProps = {
...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	public static readonly ID = 'editor.contrib.brainSelectionHelper';
	// react
	...
	constructor(
		...
		@IBrainSettingsService private readonly _voidSettingsService: IBrainSettingsService
	) {
		super();
		...
		this._instantiationService.invokeFunction(accessor => {
			...
			const res = mountBrainSelectionHelper(content, accessor);
			if (!res) return;
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		if (enabled) {
			this._rerender({ rerenderKey: this._rerenderKey } satisfies BrainSelectionHelperProps)
