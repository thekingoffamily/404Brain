...
// The extension this was called from is here - https://github.com/thekingoffamily/404Brain/blob/autocomplete/extensions/brain/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'brain.autocompleteService'
