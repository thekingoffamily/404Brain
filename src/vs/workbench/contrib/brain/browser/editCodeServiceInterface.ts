...
import { Diff, DiffArea, BrainFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getBrainFileSnapshot(uri: URI): BrainFileSnapshot;
	restoreBrainFileSnapshot(uri: URI, snapshot: BrainFileSnapshot): void;
}
