...
// gets converted to --vscode-brain-greenBG, see brain.css, asCssVariable
registerColor('brain.greenBG', configOfBG(acceptBG), '', true);
registerColor('brain.redBG', configOfBG(rejectBG), '', true);
registerColor('brain.sweepBG', configOfBG(sweepBG), '', true);
registerColor('brain.highlightBG', configOfBG(highlightBG), '', true);
registerColor('brain.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
