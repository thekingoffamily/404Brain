...
import { BrainSettingsState } from './brainSettingsService.js'
...
export type BrainStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with 404Brain. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: BrainSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: BrainSettingsState) => {
