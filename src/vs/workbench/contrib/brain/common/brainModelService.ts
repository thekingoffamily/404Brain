...
export interface IBrainModelService {
	...
	getModel(uri: URI): BrainModelType;
...
export const IBrainModelService = createDecorator<IBrainModelService>('brainModelService');

class BrainModelService extends Disposable implements IBrainModelService {
	_serviceBrand: undefined;
	static readonly ID = 'brainModelService';
	...
	getModelSafe = async (uri: URI): Promise<BrainModelType> => {
...
registerSingleton(IBrainModelService, BrainModelService, InstantiationType.Eager);
