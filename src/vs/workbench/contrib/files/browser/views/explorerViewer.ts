...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
	...
	// const brainButtonsContainer = DOM.append(container, DOM.$('div'));
	// brainButtonsContainer.style.position = 'absolute'
	// brainButtonsContainer.style.top = '0'
	// brainButtonsContainer.style.right = '0'
	// // const brainButtons = DOM.append(brainButtonsContainer, DOM.$('span'));
	// // brainButtons.textContent = 'voidbuttons'
	// // brainButtons.addEventListener('click', () => {
	// // 	console.log('ON CLICK', templateData.currentContext?.children)
	// // })
	// const brainLabels = this.labels.create(brainButtonsContainer, { supportHighlights: false, supportIcons: false, });
	// brainLabels.element.textContent = 'hi333'
	...
	// Brain cares about this function, this is where elements in the tree are rendered
