...
//#region --- Brain
import './contrib/brain/browser/brain.contribution.js'; // Brain added this
//#endregion
...
// Chat
// Brain - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
