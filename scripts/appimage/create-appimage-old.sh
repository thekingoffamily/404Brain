...
if [ ! -f "./brain.png" ]; then
    echo "Error: brain.png icon not found in current directory"
    exit 1
fi
...
cp -v ./brain.png "$APP_DIR/brain.png"
cp -v ./brain.png "$APP_DIR/usr/share/icons/hicolor/256x256/apps/brain.png"
...
Type=Application
Categories=Utility;
Comment=Brain Linux Application
EOF
then
