...
### [current] — сессия 2.2.0 (в работе)
Состояние: **параллельные tool-вызовы в агент-режиме** (по мотивам «мозгов opencode»). Сборка + релиз v1.7.5/0054 в процессе.
...
3. `product.json` → 1.7.5/0054. Desktop-сборка (~15 мин), exe запечёт HEAD `6c4ef90d`.
